        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 mb-8">
              نحن نعمل بجد لإضافة أفضل منتجات العناية بالبشرة لك. ستكون متاحة
              قريباً!
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
            ...
            <p className="text-gray-600 mb-6">
              سنقوم بإضافة مجموعة واسعة من منتجات العناية بالبشرة عالية الجودة
              المصممة خصيصاً للمرأة العربية. تابعينا للحصول على آخر التحديثات.
            </p>
